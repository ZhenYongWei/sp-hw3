...
\begin{itemize}
\item \textbf{GitHub Repository}: \url{https://github.com/zhenyong-wzy/spatial-ai-hw3}
\item \textbf{Model Weights}: \url{https://pan.baidu.com/s/1xxxxxxxxxxxxxxxx} (extraction code: \texttt{hw3s})
\end{itemize}
